#!/bin/bash
#SBATCH --job-name=gnn-brain  # Changed job name for GNN training
#SBATCH --cpus-per-task=16
#SBATCH --ntasks=1
#SBATCH --gpus-per-task=1
#SBATCH --mem=48g             # GNNs might need similar or more memory
#SBATCH -e slurm-gnn-%j.err   # Changed error file name
#SBATCH -o slurm-gnn-%j.out   # Changed output file name
...
# PyTorch specific optimizations (important for GNNs)
